...
public final class StringConsumerTest {
...
//        String[] checkerArgs = new String[]{"--group", "test3_group" --zookeeper=192.168.10.10:2181,192.168.10.11:2181,192.168.10.12:2181"};
//        ConsumerOffsetChecker.main(checkerArgs);
...
//                    ids.add(message);
//                } else {
//                    LOGGER.error("Consumer string repeated1: "+message);
//                }
            }
